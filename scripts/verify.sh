...
NODE
test "$(node -p "require('./package.json').version")" = '0.29.7'
test "$(node --input-type=module -e "import('./src/version.js').then((m) => process.stdout.write(m.VERSION))")" = '0.29.7'
...
grep -Fq "visualPromptVersion: 'visual-v17'" src/config.js
grep -Fq "evidenceContractVersion: 'evidence-v13'" src/config.js
...
grep -Fq 'evidence-v13' src/config.js
...
test "$(node -p "require('./package-lock.json').version")" = '0.29.7'
...
# V0.29.5 Visual Detail Contract
 ...
 grep -Fq "visualPromptVersion: 'visual-v17'" src/config.js
 grep -Fq "evidenceContractVersion: 'evidence-v13'" src/config.js
 grep -Fq "visualPromptVersion: config.cache?.visualPromptVersion || 'visual-v17'" src/proxy/media-adapters.js
 grep -Fq "evidenceContractVersion: config.cache?.evidenceContractVersion || 'evidence-v13'" src/proxy/media-adapters.js
