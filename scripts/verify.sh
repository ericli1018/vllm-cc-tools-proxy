...
NODE
test "$(node -p "require('./package.json').version")" = '0.2.23+hotfix.2'
test "$(node --input-type=module -e "import('./src/version.js').then((m) => process.stdout.write(m.VERSION))")" = '0.2.23.2'
